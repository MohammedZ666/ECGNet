...
int neural_net(float *ecg_input, int i, float *layer2in, float *output)
{
    dense(layer2in, &ecg_input[i], LAYER0_KERNEL, LAYER0_BIAS, 1, 61, 61, 10, 's');
    dense(output, layer2in, LAYER1_KERNEL, LAYER1_BIAS, 1, 10, 10, 4, 't');

    return argmax(output, 4);
}
